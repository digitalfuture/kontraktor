...
const migrations: Array<{ version: number; name: string; sql: string }> = [
  ...
  {
    version: 15,
    name: 'seed_system_email_templates',
    sql: `
      -- Magic Link template
      INSERT OR IGNORE INTO email_templates (name, subject, body_html, system_key, description) VALUES (
        ...
        '<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="{{login_url}}" style="display: inline-block; background: #ea580c; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Sign In →</a>
          </div>
          <p style="color: #9ca3af; font-size: 13px; word-break: break-all; background: #f9fafb; padding: 12px; border-radius: 6px;">{{login_url}}</p>
      ...
      INSERT OR IGNORE INTO email_templates (name, subject, body_html, system_key, description) VALUES (
        'New Bid',
        'New bid: {{project_title}}',
        '<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <span style="font-size: 28px; font-weight: 700; color: #ea580c;">Kontraktor</span>
          </div>
          <h2 style="color: #111827; margin-bottom: 16px;">New bid on your project</h2>
          <p style="color: #4b5563; line-height: 1.6;"><strong>{{contractor_name}}</strong> has submitted a bid on your project:</p>
          <div style="background: #f9fafb; padding: 16px; border-radius: 8px; margin: 16px 0;">
            <p style="margin: 0; font-weight: 600; color: #111827;">{{project_title}}</p>
          </div>
          <div style="text-align: center; margin: 24px 0;">
            <a href="{{project_url}}" style="display: inline-block; background: #ea580c; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">View Bids →</a>
          </div>
          <p style="color: #9ca3af; font-size: 12px; margin-top: 24px;">You can review and accept bids from your project page.</p>
        </div>',
        'new_bid',
        'Sent to client when a contractor submits a bid. Supports: {{recipient_name}}, {{company_name}}, {{project_title}}, {{project_url}}, {{contractor_name}}'
      );
      -- Bid Accepted template
      INSERT OR IGNORE INTO email_templates (name, subject, body_html, system_key, description) VALUES (
        'Bid Accepted',
        'Bid accepted: {{project_title}}',
        '<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <span style="font-size: 28px; font-weight: 700; color: #ea580c;">Kontraktor</span>
          </div>
          <h2 style="color: #111827; margin-bottom: 16px;">🎉 Your bid was accepted!</h2>
          <p style="color: #4b5563; line-height: 1.6;"><strong>{{client_name}}</strong> has accepted your bid on:</p>
          <div style="background: #f0fdf4; padding: 16px; border-radius: 8px; margin: 16px 0; border: 1px solid #bbf7d0;">
            <p style="margin: 0; font-weight: 600; color: #166534;">{{project_title}}</p>
          </div>
          <div style="text-align: center; margin: 24px 0;">
            <a href="{{project_url}}" style="display: inline-block; background: #ea580c; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">View Dashboard →</a>
          </div>
          <p style="color: #9ca3af; font-size: 12px; margin-top: 24px;">Contact the client to discuss project details.</p>
        </div>',
        'bid_accepted',
        'Sent to contractor when their bid is accepted. Supports: {{recipient_name}}, {{company_name}}, {{project_title}}, {{project_url}}, {{client_name}}'
      );
      -- Project Completed template
      INSERT OR IGNORE INTO email_templates (name, subject, body_html, system_key, description) VALUES (
        'Project Completed',
        'Project completed: {{project_title}}',
        '<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <span style="font-size: 28px; font-weight: 700; color: #ea580c;">Kontraktor</span>
          </div>
          ...
          <div style="background: #f9fafb; padding: 16px; border-radius: 8px; margin: 16px 0;">
            <p style="margin: 0; font-weight: 600; color: #111827;">{{contractor_name}}</p>
            <p style="margin: 4px 0 0; color: #6b7280; font-size: 14px;">{{project_title}}</p>
          </div>
          <div style="text-align: center; margin: 24px 0;">
            <a href="{{project_url}}" style="display: inline-block; background: #ea580c; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Leave Review →</a>
          </div>
        </div>',
        'project_completed',
        'Sent to client when a project is marked completed. Supports: {{recipient_name}}, {{company_name}}, {{project_title}}, {{project_url}}, {{contractor_name}}'
      );
    `,
  },
];
